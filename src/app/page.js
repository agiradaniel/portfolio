...
import PortfolioImage from '../../public/portfolioimage-min.png'
...
import ImmotechProject from '../../public/immotechproject.png'
      ...
      <div className={styles.aboutsection} id="about">
        ...
        <div className={styles.abouttextcontainer}>
          ...
          <p>From iOS to Android, web, and desktop, I possess a diverse range of capabilities. 
            ...
            <Button><a style={{textDecoration:"none", color:"black"}} href="http://localhost:3000/portfoliocv.pdf" target="_blank" rel="noreferrer">Resume</a></Button>
        </div>
      ...
      <div className={styles.techstacksection}>
        ...
        <div className={styles.techstack}>
          ...
          <div>
            ...
            <div className={styles.innertechdiv}>
              <Image src={SupabaseLogo} style={{margin:"4px 8px 0 0"}} alt="Supabase logo"/>
              <p>SupaBase</p>
            </div>
